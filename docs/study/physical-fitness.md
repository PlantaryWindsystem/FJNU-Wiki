...
由体育科学学院的研究生开发的站点：[福师大体育服务指南](https://fjnusport.com/)。由于网站托管在国外服务器，不保证能够正常访问。
...
学生须通过个人手机连接校园网（若未购买校园网，请[点此查看替代方案](../service/network.md#login-without-campus-network)），通过 福Star APP - 体质测试 打开体测系统（或[点此进入体测系统](https://tcxt.fjnu.edu.cn)），在体测预约模块中线上预约个人测试项目及时间，并在已预约的时间段（每个时间段长度为 1 小时）内**携带身份证原件**到达测试地点完成测试。

**室内项目和室外项目（50 米、800/1000 米）不能预约在同一个半天内。** 每位学生在同一学期内有室内、室外项目各 2 次预约后取消预约的机会，取消预约需至少提前 24 小时进行。不在已预约时段内的体测数据将被当作无效数据处理，经实测同一个半天内均可（例如预约 10:00-11:00，则 8:00-10:00 或 11:00-11:30 间完成测试亦可），但超出半天外的数据会被计为无效。

我校体测所有项目均采用刷身份证、机器计算的方式。
...
因病或因故不能参与学生体质健康测试或义务服兵役期满退役复学的学生可以申请免测。具体流程如下：
...
免测申请成功的学生无需再预约参加体测。即使正常参加测试，最终的测试成绩也会被“免测”所覆盖。
...
!!! tip "免测材料申请提示"
    ...
    补充：在实际执行中免测申请为人工审核，审核标准不一、可能出现误判。部分保健班学生以保健班名单申请免测同样会被打回。出现此类问题时，请咨询大体部相关办公室。

!!! info "免测学生的体测分数、评奖评优处理办法"
    === "2025 级学生"
        1. 因加入保健班申请免测的学生的当年体测成绩计为当年两学期体育课程成绩的平均值、以该成绩参与评奖评优，在计算毕业成绩时不计入。
        2. 义务服兵役期满退役复学的学生的全年体测成绩计为 60 分、以该成绩参与评奖评优，在计算毕业成绩时不计入。
        3. 因访学无法参与体测的学生当年体测成绩计为往年体测成绩的平均值、以该成绩参与评奖评优，在计算毕业成绩时不计入。
        4. 非保健班因伤病申请当学年免测的学生，当年体测成绩计50分。
    === "2022、2023、2024 级学生"
...
!!! tip "提示"
    缓测无需单独申请。正测未参加且未提交免测申请学生自动纳入缓补测名单。

【体测正测成绩未达到 60 分】或【未预约测试 且 免测申请未提交或未通过】的同学需要参加 补测，相关工作会在次年 3 月进行，流程与体测正测相同。

补测时可以自由选择测试项目，体测各项目最终成绩取两次测试中较高的一次。

!!! tip "提示"
    若因体测正测成绩未达到 60 分而被列入补测名单，亦可以不去参加补测。
...
体测成绩在测试时不会告知（但可以在测试完毕后的极短时间内自行查看教师屏幕上的数据，50 米、1000 米等部分项目受物理条件限制需要有人帮你查看或无法查看），会在当学期体测工作完成后下发，通过 福Star APP - 体质测试 打开体测系统（或[点击此处进入体测系统，仅限校园网](https://tcxt.fjnu.edu.cn)）中的【学年成绩查询】模块进行查询。
...
- 保健班学生在提交对应免测材料后无需参加[体测](#fitness-test)。在进行综测评优评先计算时，以 当学年内两个学期的《调适体育》课程平均分 计入。即：当学年内两个学期的《调适体育》课程平均分达到 80 分的，计为良好。
...
!!! tip "提示"
    若手机为安卓系统且未开启无障碍权限，跑步过程需要全程亮屏，否则 APP 无法获取到定位，可能发生路径漏算、漂移等问题。

- 2019年7月16日，工信部等指导成立的APP专项治理工作组发布了《关于督促40款存在收集使用个人信息问题的App运营者尽快整改的通知》，步道乐跑因在个人信息手机使用方面存在问题，且未公开有效联系方式，遭工作组点名。
- 2021年6月8日，工信部发布关于侵害用户权益行为的App通报（2021年第5批，总第14批），步道乐跑APP在列，理由为“APP强制、频繁、过度索取权限”。
- 2021年6月11日，工信部通报步道乐跑APP“违反必要原则和《常见类型移动互联网应用程序必要个人信息范围规定》，收集与其提供的服务无关的个人信息；未经用户同意收集使用个人信息等”。
- 2026年5月27日，多名合肥工业大学学生反映其因反馈体测成绩异常而被乐跑体育工作人员删除体测成绩。工作人员发言原文如下：“有成绩还来反馈？我给你成绩清除了，直接补测吧”。部分学生因反馈成绩异常而被移出群聊。

公共体育教学部（大体部）此前声称“步道乐跑是一款无广告、纯绿色的APP”，但根据不完全统计，截至2026年5月29日，步道乐跑APP内存在以下形式的广告：

| 触发点 | 形式 | 持续时间 | 备注 |
| --- | --- | --- | --- |
| 启动应用时 | 摇一摇广告 | 5秒 | 帮助你启动淘宝、京东等应用 |
| 进入主界面后 | 摇一摇广告 | 无，手动关闭 | 帮助你打开应用商店、下载抖音 |
| 进入“动态”界面时 | 摇一摇广告 | 无，手动关闭 | 帮助你打开应用商店、下载抖音 |
| 在“动态”界面浏览时概率触发 | 摇一摇广告 | 无，手动关闭 | 帮助你打开应用商店、下载抖音 |
| 进入“个人中心”页面后 | 摇一摇广告 | 无，手动关闭 | 帮助你打开应用商店、下载抖音 |
| 进入“校园”页面后概率触发 | 摇一摇广告 | 无，手动关闭 | 帮助你打开应用商店、下载抖音 |
| 跑步结束、上传记录后 | 摇一摇广告 | 5秒 | 帮助你打开淘宝、京东、美团等应用 |

同时，步道乐跑APP会以“开启无障碍可以快速设置跑步所需的必要权限，并为您在后台持续记录运动轨迹”为由引导用户开启无障碍权限。无障碍权限开启后APP能够实时读取屏幕内容（包括密码等隐私信息）、控制屏幕的点击和操作、随时在后台自启动等。
...
公共体育理论考试是大学体育（一）的分数组成部分之一，占学期课程总分中的 20 分。
...
请参考：[公共体育理论考试题库](https://wefjnu.nekoark.com/sport/)。
